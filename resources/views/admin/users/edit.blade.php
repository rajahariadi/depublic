...
@section('content')
    <div class="card">
        <div class="card-body">
            <div>
                <h3 class="card-title"><i class='bx bx-group me-2'></i>Edit User</h3>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('admin.users.update', $data->id) }}" method="POST"> @csrf @method('PUT')
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" id="myInput" placeholder="Password"
                                aria-describedby="defaultFormControlHelp" name="password" value="{{ $data->password }}">
                        ...
                        @error('password')
                            <div class="mt-2 text-danger">{{ $password }}</div>
                        @enderror
                        <br> --}}
