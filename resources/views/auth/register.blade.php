            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="sign-up-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <input placeholder="Name" type="text" class="form-control w-100" id="name"
                        ...
                        <div class="mb-3" style="position: relative;">
                            ...
                            <img class="img-eye-close" src="{{ asset('assets/images/eye.png') }}"
                                onclick="togglePasswordVisibility('password', 'eyeToggle')" id="eyeToggle">
                        </div>
                        <div class="mb-3" style="position: relative;">
                            <input placeholder="Confirm Password" type="password" class="form-control w-100"
                            ...
                            @enderror
                            <img class="img-eye-close" src="{{ asset('assets/images/eye.png') }}"
                                onclick="togglePasswordVisibility('password_confirmation', 'eyeToggleConfirm')"
                                id="eyeToggleConfirm">
                        </div>
                        ...
                        <button type="submit" id="sign-up-button"
                            class="signUp-btn btn-primary w-100 rounded-4 w-100">Create Account</button>
                    </form>
                    <div class="text-center"
                        style="margin-top: 30px; margin-bottom: 25px; font-weight: 500; font-size: 16px;">
                        <a href="{{ route('login') }}" style="color: #A6A6A6; text-decoration: none;">Have
                            an Account? <span style="color: #A103D3; font-weight: bold;">Login</span></a>
                    </div>
                </div>
...
<script>
    function togglePasswordVisibility(inputId, eyeToggleId) {
        var passwordInput = document.getElementById(inputId);
        var eyeToggle = document.getElementById(eyeToggleId);
    ...
    // Optional: synchronize visibility if one password field changes
    document.getElementById('password').addEventListener('input', function() {
        ...
        if (passwordInput.type === 'text') {
            ...
            document.getElementById('eyeToggleConfirm').src = "{{ asset('assets/images/view.png') }}";
        } else {
            confirmPasswordInput.type = 'password';
            document.getElementById('eyeToggleConfirm').src = "{{ asset('assets/images/eye.png') }}";
        }
    });
</script>
<script>
